...
// Canonical in-world dimension formatter. Shared by every measurement readout
// so metric, imperial, and millimeter displays read the same.
export function formatMeasurement(value: number, unit: LinearUnit): string {
  return formatLinearMeasurement(value, unit)
}
